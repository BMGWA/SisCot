...
<body>
	...
	<a href="/SisCot/DeleteProduct?name=<%= request.getParameter("productName") %>"> Deletar Produto</a>	<br> 
	<a href="/SisCot/UpdateProduct?name=<%= request.getParameter("productName") %>""> Alterar Produto</a>
	</div>
	</div>
