...
<body>
	...
	<a href="/SisCot/DeleteProduct?name=<%= request.getParameter("productName") %>"> Deletar Contato</a>	<br> 
	<a href="/SisCot/UpdateProduct?name=<%= request.getParameter("productName") %>""> Alterar Contato</a>
	</div>
	</div>
